...
namespace Application.Tests
{
    public sealed class GetAllProductsQueryHandlerTests
    {
        ...
        private GetAllProductsQueryHandler CreateHandler() => new(_repository, _currentUser);
        ...
        public async Task Handle_PassesCurrentUserAllowedPslIdsToRepository()
        {
            ...
            await CreateHandler().Handle(new GetAllProductsQuery(), CancellationToken.None);
